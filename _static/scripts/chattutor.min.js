...
const base_url_CHATTUTOR_SERVER = CHATTUTOR_BASE_URL ? CHATTUTOR_BASE_URL : "https://chattutor.org"
const BASE_URL = testmode ? "http://127.0.0.1:5000" : base_url_CHATTUTOR_SERVER;
...
headers.append("Authorization", "Bearer " + AUTHORIZATION_KEY)
...
function setupEmbedMode_URL() {
  ...
  if (
    ...
    // path = path.substr(ind, end);
    console.log("path " + path)
  } else {
    console.log("!! BAD CONFIG FOR LOCAL RUN!")
  }
  original_file = COURSE_URL + path;
  console.log(COURSE_URL)
  original_file = original_file.replaceAll(/[^A-Za-z0-9\-_]/g, "_");
  console.log("requesting from document\n")
  console.log(original_file);
...
//     let response = await fetch(BASE_URL + '/upload_site_url', {
//         method: 'POST',
//         headers: headers,
//         body: JSON.stringify(data_)
//     })
