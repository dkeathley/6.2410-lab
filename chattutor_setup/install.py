...
with open("./chattutor_setup/chattutor.html") as f:
...
shutil.copyfile("./chattutor_setup/chattutor.css", css_path)
shutil.copyfile("./chattutor_setup/chattutor.js", js_path)